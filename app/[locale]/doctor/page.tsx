...
export const metadata: Metadata = {
  ...
  description:
    "Meet Dr. Alhad Pande, MBBS MD DGO — Obstetrician, Gynecologist and Fertility Specialist at Krisha Women's Hospital, Narol, Ahmedabad with 10+ years of expertise in high-risk pregnancy, IVF, and laparoscopic surgery.",
